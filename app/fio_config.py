...
DASH_PRIVATE_BH_SMALL_PATH = OUTPUT_DATA_DIR / 'dashboard_private_boreholes_sampled.csv'
DASH_GOVERNMENT_BH_SMALL_PATH = OUTPUT_DATA_DIR / 'dashboard_government_boreholes_sampled.csv'

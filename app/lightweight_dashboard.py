"""Ultra-lightweight Streamlit dashboard for pathogen scenario modeling.

Optimized for low-memory systems (<4GB RAM) with minimal features focused on
essential decision-making metrics for stakeholders.
"""
...
def set_page_config():
    ...
    st.set_page_config(
        page_title="Zanzibar Pathogen Model - Lightweight",
        page_icon="🌊",
        layout="centered"
    )
...
def create_simple_scenario_form() -> Dict[str, Any]:
    ...
    scenario = {
        'scenario_name': 'lightweight_scenario',
...
def main():
    ...
    st.markdown("**Lightweight Dashboard - Optimized for Low-Memory Systems**")
    ...
    with st.expander("ℹ️ How to Use"):
        ...
        **Memory Optimized**: This dashboard uses minimal memory and processing power,
        suitable for systems with less than 4GB RAM.
        """)
    
    # Performance info
    st.caption("💡 Lightweight version - Complex visualizations and comparisons removed for performance")
